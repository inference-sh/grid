...
from magi.common import EngineConfig, InferenceParams, ModelConfig, ModelMetaArgs, PackedCrossAttnParams, divide
from magi.infra.distributed import parallel_state
from magi.infra.parallelism import CSOHelper, UlyssesScheduler, cso_communication
...
class Attention(torch.nn.Module):
    ...
    def _allocate_key_and_value_memory(self, sequence_length, batch_size, dtype):
        """Allocate memory to store kv cache during magi."""
...
class FullyParallelAttention(Attention):
    ...
    def _full_adjust_key_and_value(
        ...
        """
        # =================================================
        # Pre-allocate memory for key-values for magi.
        # =================================================
