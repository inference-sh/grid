...
class App(BaseApp):
    ...
    async def run(self, input_data: AppInput, metadata) -> AppOutput:
        ...
        self.genv(
            ...
            model_filename=os.path.join("ckpts", self.i2v_transformer_filename) #os.path.join(self.ckpts_dir, self.i2v_transformer_filename)  # Include full path to model file
        )
