...
from models.wan_modules.t5 import T5EncoderModel
from models.wan_modules.vae import WanVAE
from models.utils.utils import tensor_to_video, prepare_json_dataset
from contextlib import contextmanager
import torch.cuda.amp as amp
from models.utils.fm_solvers_unipc import FlowUniPCMultistepScheduler
from utils.audio_processor_whisper import AudioProcessor
from utils.wav2vec import linear_interpolation_fps
...
class Generator():
    ...
    def configure_dit_model(self, device=get_device()):
        ...
        with torch.device(init_device):
            from models.wan_modules.model_humo import WanModel
            self.dit = WanModel(**self.config.dit.model)
        ...
        if path.endswith(".pth"):
            ...
            # Load the index file
            index_path = os.path.join(path, "humo.safetensors.index.json")
            ...
            self.dit.load_state_dict(state_dict, strict=False, assign=True)
    ...
    def configure_dit_fsdp_model(self):
        from models.wan_modules.model_humo import WanAttentionBlock
    ...
    def configure_text_fsdp_model(self):
        ...
        from models.wan_modules.t5 import T5SelfAttention
