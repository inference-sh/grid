...
class AppInput(BaseAppInput):
    ...
    aspect_ratio: AspectRatioEnum = Field(
        ...
        description="Aspect ratio for the output image. Default: 16:9"
    )
...
class App(BaseApp):
    async def setup(self, metadata):
        ...
        self.model_id = "fal-ai/gemini-3-pro-image-preview"
    ...
    async def run(self, input_data: AppInput, metadata) -> AppOutput:
        ...
        try:
            ...
            self.logger.info("Starting image generation with Gemini 3 Pro")
            ...
            # Prepare output with image and description
