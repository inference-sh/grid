"""
Qwen-Image-Fast - Fast text-to-image generation
"""
...
class AppInput(BaseAppInput):
    ...
    width: Optional[int] = Field(default=None, ge=256, le=1440, description="Width (custom aspect_ratio only, multiple of 16).")
    height: Optional[int] = Field(default=None, ge=256, le=1440, description="Height (custom aspect_ratio only, multiple of 16).")
    creativity: float = Field(default=0.62, ge=0, le=1, description="Creativity level (higher = more diverse).")
