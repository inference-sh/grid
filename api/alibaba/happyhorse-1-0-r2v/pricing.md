# HappyHorse 1.0 Reference-to-Video Pricing
...
- **Input images:** Free (up to 9 reference images)
...
| Number of reference images | No additional cost (1-9 images) |

## Example

A 5-second video at 720P with 3 reference images:
- Cost = $0.14 x 5 = **$0.70**
