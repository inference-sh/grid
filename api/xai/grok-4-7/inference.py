...
# Reasoning effort low, medium, high or xhigh; reasoning cannot be turned off, so "none" is sent as "low".
REASONING_EFFORTS = ("low", "medium", "high", "xhigh")


class AppInput(LLMInput):
    """grok-4.7 via the xAI Responses API: text and image input, tools, reasoning."""
    context_size: int = Field(default=500000, description="The context size for the model.")
