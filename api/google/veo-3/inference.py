    ...
    async def run(self, input_data: RunInput) -> RunOutput:
        ...
        try:
            ...
            for i, video_info in enumerate(videos):
                ...
                output_meta_videos.append(VideoMeta(width=width, height=height, seconds=delivered_seconds, resolution=input_data.resolution.value, extra={"generate_audio": input_data.generate_audio}))
