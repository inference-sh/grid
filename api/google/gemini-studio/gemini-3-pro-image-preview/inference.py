"""
Gemini 3 Pro Image Preview with fal.ai fallback.

Uses Vertex AI with automatic fallback to fal.ai (nano-banana-pro) on rate limits.
"""
...
class App(BaseApp):
    async def setup(self):
        ...
        self.fal_text_model = "fal-ai/nano-banana-pro"
        self.fal_edit_model = "fal-ai/nano-banana-pro/edit"
        self.client = create_vertex_client()
        self.logger.info("Gemini 3 Pro Image Preview (with fal fallback) initialized")
