"""
Gemini 3.1 Flash Lite Image (NanoBanana 2 Lite) via Vertex AI.

Ultra-low latency image generation and editing powered by Google Cloud.
"""
...
class ExtendedAspectRatioAutoEnum(str, Enum):
    """Aspect ratios including extreme ratios supported by Flash Lite Image."""
    auto = "auto"
    ratio_21_9 = "21:9"
    ratio_16_9 = "16:9"
    ratio_8_1 = "8:1"
...
class AppInput(BaseAppInput):
    ...
    aspect_ratio: ExtendedAspectRatioAutoEnum = Field(
        ...
        description="Aspect ratio. Supports extreme ratios like 1:4, 4:1, 1:8, 8:1. Use 'auto' to match input image."
    )
    resolution: ResolutionEnum = Field(
        default=ResolutionEnum.res_1k,
        description="Output resolution: 512, 1K, 2K, 4K."
    )
...
class App(BaseApp):
    async def setup(self):
        ...
        self.model_id = "gemini-3.1-flash-lite-image"
        self.client = create_vertex_client()
        self.logger.info("Gemini 3.1 Flash Lite Image (Vertex AI) initialized")
