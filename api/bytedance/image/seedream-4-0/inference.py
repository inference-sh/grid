"""
Seedream 4.0 - BytePlus Image Generation
...
class AppInput(BaseAppInput):
    """Input schema for Seedream 4.0 image generation."""
...
class AppOutput(BaseAppOutput):
    """Output schema for Seedream 4.0 image generation."""

    image: File = Field(description="The generated image file.")


class App(BaseApp):
    """Seedream 4.0 image generation application using BytePlus ARK SDK."""
    ...
    async def setup(self, metadata):
        ...
        self.logger.info(f"Seedream 4.0 initialized with model: {self.model_id}")

    async def run(self, input_data: AppInput, metadata) -> AppOutput:
        """Generate image using Seedream 4.0."""
        try:
