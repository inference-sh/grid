"""
Seedance 1.0 Pro - BytePlus Video Generation
...
class AppInput(BaseAppInput):
    """Input schema for Seedance 1.0 Pro video generation."""
...
class AppOutput(BaseAppOutput):
    """Output schema for Seedance 1.0 Pro video generation."""
...
class App(BaseApp):
    ...
    async def setup(self, metadata):
        ...
        self.model_id = "seedance-1-0-pro-250528"

        self.cancel_flag = False
        self.current_task_id = None

        self.logger.info(f"Seedance 1.0 Pro initialized with model: {self.model_id}")
