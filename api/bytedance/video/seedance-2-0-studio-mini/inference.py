...
Same capabilities as Seedance 2.0 Mini, but automatically uploads reference
images, videos, and audio to the BytePlus private virtual portrait library for
enhanced character consistency. Uses asset:// URIs instead of direct URLs for
trusted asset generation.
"""
...
class AppInput(BaseAppInput):
    ...
    Same as Seedance 2.0 Mini, but all references are automatically uploaded to
    the private virtual portrait library for enhanced character consistency.
...
class App(SeedanceStudioApp):
    ...
    display_name: ClassVar[str] = "Seedance 2.0 Mini Studio"
    model_id: ClassVar[str] = "dreamina-seedance-2-0-mini-260615"
    unfiltered_model_id: ClassVar[Optional[str]] = "ep-20260711220818-87j2z"
    OutputType: ClassVar[Any] = AppOutput

    async def run(self, input_data: AppInput, metadata) -> AppOutput:
        """Generate video using Seedance 2.0 Mini Studio."""
