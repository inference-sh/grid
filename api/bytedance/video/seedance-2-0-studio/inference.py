...
class AppInput(BaseAppInput):
    ...
    Same as Seedance 2.0, but all references are automatically uploaded to the
...
class App(SeedanceStudioApp):
    ...
    display_name: ClassVar[str] = "Seedance 2.0 Studio"
    model_id: ClassVar[str] = "dreamina-seedance-2-0-260128"
    unfiltered_model_id: ClassVar[Optional[str]] = "ep-20260514173157-ppqhm"
    OutputType: ClassVar[Any] = AppOutput

    async def run(self, input_data: AppInput, metadata) -> AppOutput:
        """Generate video using Seedance 2.0 Studio."""
