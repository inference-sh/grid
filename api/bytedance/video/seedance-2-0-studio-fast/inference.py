...
class AppInput(BaseAppInput):
    ...
    Same as Seedance 2.0 Fast, but all references are automatically uploaded to
...
class App(SeedanceStudioApp):
    ...
    display_name: ClassVar[str] = "Seedance 2.0 Studio Fast"
    model_id: ClassVar[str] = "dreamina-seedance-2-0-fast-260128"
    unfiltered_model_id: ClassVar[Optional[str]] = "ep-20260514172956-2jlxn"
    OutputType: ClassVar[Any] = AppOutput

    async def run(self, input_data: AppInput, metadata) -> AppOutput:
        """Generate video using Seedance 2.0 Studio Fast."""
