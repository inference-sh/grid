...
class App(BaseApp):
    ...
    async def setup(self, metadata):
        ...
        self.unfiltered_model_id = "ep-20260514172956-2jlxn"

        self.cancel_flag = False
        self.current_task_id = None

        self.logger.info(f"Seedance 2.0 Fast initialized with model: {self.model_id}")
    ...
    async def run(self, input_data: AppInput, metadata) -> AppOutput:
        ...
        try:
            ...
            self.logger.info(f"Starting {mode} generation (fast)")
