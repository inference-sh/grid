"""
Kling Image V1 (Kolors V1.0) - Basic Image Generation

Basic text-to-image and image-to-image. Cheapest option at $0.0035/image.
"""
...
class AppInput(BaseAppInput):
    """Kolors V1.0 - basic text-to-image and image-to-image."""

    prompt: str = Field(description="Text description. Max 2500 chars.")
    image: Optional[File] = Field(default=None, description="Reference image for image-to-image (entire image style transfer).")
...
class App(BaseApp):
    async def setup(self, metadata):
        ...
        self.logger.info("Kling Image V1 initialized")
    ...
    async def run(self, input_data: AppInput) -> AppOutput:
        ...
        output_meta = OutputMeta(outputs=[ImageMeta(count=input_data.n, extra={"model": "kling-v1", "mode": mode})])
