"""
GPT Image 2.5 Sunburst - OpenAI Image Generation

Generate and edit images using OpenAI's gpt-image-2.5-sunburst model.
...
class AppInput(BaseAppInput):
    """Input schema for GPT Image 2.5 Sunburst generation."""
...
class AppOutput(BaseAppOutput):
    """Output schema for GPT Image 2.5 Sunburst generation."""

    images: list[File] = Field(description="The generated image files.")


class App(BaseApp):
    """GPT Image 2.5 Sunburst image generation application."""
