...
def extract_image_url(image_payload) -> Optional[str]:
    if isinstance(image_payload, dict):
        image_block = image_payload.get("image_url")
        return image_block.get("url") if isinstance(image_block, dict) else None
    return None
            ...
            try:
                ...
                async for chunk in stream_iterator:
                    ...
                    if hasattr(delta, "images") and delta.images:
                        for image_payload in delta.images:
                            image_url = extract_image_url(image_payload)
                    ...
                    if image_urls:
                        ...
                        output_data["images"] = [File(uri=image_url) for image_url in image_urls]
