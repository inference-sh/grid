...
# Model variants mapping for GGUF quantization from QuantStack (same as base T2I)
MODEL_VARIANTS = {
...
class AppInput(BaseAppInput):
    ...
    num_inference_steps: int = Field(default=4, description="Number of denoising steps (fixed CFG=1.0)")
...
class App(BaseApp):
    async def setup(self, metadata):
        print("Setting up Wan2.2 T2I with LightX2V LoRA...")
        ...
        if base_variant == "default":
            # Standard F16 pipeline with dual transformers
        ...
        # Load LightX2V LoRAs on both transformers, non-fused
        ...
        self.pipe.set_adapters(["lightning", "lightning_2"], adapter_weights=[1.5, 3.0])
