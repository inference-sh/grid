...
class App(BaseApp):
    async def setup(self, metadata):
        ...
        if base_variant == "default":
            # Use the original Qwen-Image-Edit model with Lightning scheduler
            logging.info("Loading Qwen-Image-Edit model with Lightning scheduler")
            ...
            logging.info(f"Loading Qwen-Image-Edit GGUF variant: {base_variant} ({filename}) with Lightning scheduler")
        ...
        logging.info("Qwen-Image-Edit Lightning pipeline initialized successfully")
