...
class App(BaseApp):
    ...
    async def run(self, input_data: AppInput) -> AppOutput:
        ...
        if is_video:
            ...
            output_path = self._process_video(input_data)
        else:
            # Handle image processing
            output_path = self._process_image(input_data)
        
        return AppOutput(result=File(path=output_path))

    def _process_image(self, input_data: AppInput) -> str:
    ...
    def _process_video(self, input_data: AppInput) -> str:
