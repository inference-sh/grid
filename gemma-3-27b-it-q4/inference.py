...
class App(BaseApp):
    ...
    async def run(self, input_data: AppInput) -> AsyncGenerator[AppOutput, None]:
        ...
        if hasattr(input_data, 'enable_thinking') and input_data.enable_thinking:
        ...
        buffer = ""
        thinking_content = ""
        in_thinking = hasattr(input_data, 'enable_thinking') and input_data.enable_thinking
        ...
        while True:
            ...
            if hasattr(input_data, 'enable_thinking') and input_data.enable_thinking and thinking_content:
