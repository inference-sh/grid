...
class App(BaseApp):
    ...
    async def run(self, input_data: AppInput) -> AppOutput:
        ...
        if input_data.operator == ComparisonOperator.EQUAL:
            condition_met = input_data.left_operand == input_data.right_operand
        elif input_data.operator == ComparisonOperator.GREATER_THAN:
            condition_met = input_data.left_operand > input_data.right_operand
        elif input_data.operator == ComparisonOperator.GREATER_EQUAL:
            condition_met = input_data.left_operand >= input_data.right_operand
        elif input_data.operator == ComparisonOperator.LESS_EQUAL:
            condition_met = input_data.left_operand <= input_data.right_operand
        elif input_data.operator == ComparisonOperator.LESS_THAN:
            condition_met = input_data.left_operand < input_data.right_operand
