...
def cleanup_directory(directory: str):
    ...
    try:
        ...
        logger.warning(f"    ⚠️  Failed to clean directory {directory}: {e}")
...
class App(BaseApp):
    ...
    async def setup(self, metadata=None):
        ...
        logger.info("🔧 Setting up Python Code Executor...")

        # Verify Python environment
        logger.info(f"    Python version: {sys.version}")
        logger.info(f"    Python executable: {sys.executable}")

        logger.info("✅ Python Code Executor setup complete")
    ...
    async def run(self, input_data: AppInput, metadata=None) -> AppOutput:
        ...
        try:
            logger.info(f"🐍 Executing Python code (timeout: {input_data.timeout}s)")
            ...
            try:
                ...
                try:
                    ...
                    logger.warning(f"    ⚠️  Could not create outputs directory: {e}")
                ...
                for filepath in sorted(new_files):
                    if os.path.isfile(filepath):
                        ...
                        logger.info(f"    📄 Found output file: {os.path.relpath(filepath, working_dir)}")
